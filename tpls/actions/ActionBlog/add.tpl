...
<form method="post" enctype="multipart/form-data" class="wrapper-content">
	...
	<div class="form-group">
		...
		<p class="help-block"><small>{$aLang.blog_create_title_notice}</small></p>
	</div>
	...
	<div class="form-group">
		...
		<p class="help-block"><small>{$aLang.blog_create_url_notice}</small></p>
	</div>
	...
	<div class="form-group">
		...
		<p class="help-block"><small>{$aLang.blog_create_type_open_notice}</small></p>
	</div>
	...
	<div class="form-group">
		...
		<p class="help-block"><small>{$aLang.blog_create_description_notice}</small></p>
	</div>
	...
	<div class="form-group">
		...
		<p class="help-block"><small>{$aLang.blog_create_rating_notice}</small></p>
	</div>
